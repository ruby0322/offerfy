...
export default function Hero() {
  ...
  return (
    <section className="mx-auto max-w-[40rem] px-5 pb-16 pt-16 md:pb-20 md:pt-24">
      ...
      <h1 className="landing-display mt-4 max-w-[18ch] text-[1.9rem] leading-[1.18] tracking-tight text-[var(--landing-ink)] md:text-[2.65rem]">
        {t("headline")}
      </h1>
      <p className="mt-4 max-w-[34ch] text-base leading-relaxed text-[var(--landing-muted)] md:text-lg">
        {t("sub")}
      </p>
